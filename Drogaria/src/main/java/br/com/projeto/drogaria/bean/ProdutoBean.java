...
public class ProdutoBean implements Serializable {
	...
	public void editar(ActionEvent evento){
		try {
			...
			produto.setCaminho("C:/Users/Silvan de Jesus/Downloads/Upload/" + produto.getCodigo() + ".png");
	...
	public void salvar() {
		try {
			if(produto.getCaminho() == null){
				Messages.addGlobalError("Selecione uma foto para o produto");
				return;
			}
			ProdutoDAO produtoDAO = new ProdutoDAO();
			...
			Path destino = Paths.get("C:/Users/Silvan de Jesus/Downloads/Upload/" + produtoRetorno.getCodigo() + ".png"); 
	...
	public void excluir(ActionEvent evento) {
		try {
			...
			Path destino = Paths.get("C:/Users/Silvan de Jesus/Downloads/Upload/" + produto.getCodigo() + ".png"); 
